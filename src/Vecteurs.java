...
public class Vecteurs {
	 ...
	 * @return un tableau dynamique trié.
	 */
	 ...
	 * @return un tableau dynamique dont ses élements sont la meme des élements des deux tableaux en entrée.
	 */
	...
	/**
	 * inverse (ArrayList(Long) tab): est une méthode (long) qui sert à inverser les élements du tableau en faisant un parcours du tableau 
	 ...
	 * @return un tableau dynamique dont ses élements son inversés par rapport au tableau en entrée.
	 */
	 ...
	 * @return le Min du tableau dyanamique en entrée.
	 */
